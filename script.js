...
function randomNumbers() {
  ...
  for (let i = 0; i <= 4; i++) {
    ...
    dobbel = i + 1 + "";
    if (chosen[i] == false) {
      document.getElementById("dobbelsteen-" + dobbel).style.backgroundImage =
        "url('dice" + (randomNum[i] - 1) + ".png')";
    }
  }
}

document.getElementsByClassName("rol")[0].onclick = function () {
  // rolt de dobbelsteenen 3X max
  tel++;
  if (tel == 1) {
...
document.addEventListener("click", function (event) {
  //checkt of je de punten kan zetten voor 1 tot 6
  for (let j = 1; j <= 6; j++) {
    target = "punten-" + j;
    if (
...
document.addEventListener("click", function (event) {
  for (i = 0; i <= 5; i++) {
    // doet de punten van 3 dezelfde
    if (
      event.target.id == "punten-7" &&
      isRolling == true &&
      pressed[6] == false &&
      count[i] == 3
    ) {
  ...
  for (i = 0; i <= 5; i++) {
    // doet de punten van 4 dezelfde
    if (
      event.target.id == "punten-8" &&
      isRolling == true &&
      pressed[7] == false &&
      count[i] == 4
    ) {
  ...
  for (i = 0; i <= 5; i++) {
    // doet de punten van 3+2 dezelfde
    if (
      event.target.id == "punten-9" &&
      isRolling == true &&
      pressed[8] == false &&
      count[i] == 3
    ) {
  ...
  for (i = 0; i <= 2; i++) {
    //punten voor 4 opvolgende cijfers
    if (
      event.target.id == "punten-10" &&
      count[i] == 1 &&
      count[i + 1] == 1 &&
      count[i + 2] == 1 &&
      count[i + 3] == 1 &&
  ...
  for (i = 0; i <= 1; i++) {
    //punten voor 5 opvolgende cijfers
    if (
      event.target.id == "punten-11" &&
      count[i] == 1 &&
      count[i + 1] == 1 &&
      count[i + 2] == 1 &&
      count[i + 3] == 1 &&
  ...
  for (i = 0; i <= 5; i++) {
    // doet de punten van 5 dezelfde
    if (
      event.target.id == "punten-12" &&
      isRolling == true &&
      pressed[11] == false &&
      count[i] == 5
    ) {
  ...
  if (
    event.target.id == "punten-13" &&
    pressed[12] == false &&
    isRolling == true
  ) {
    // doet punten van totaal
...
function showsRed() {
  ...
  totaalVD5 = 0; //Krijgt het totaal van de getallen
  for (let i = 0; i <= 4; i++) {
    totaalVD5 += chosenValue[i];
  }

  for (i = 0; i <= 5; i++) {
    // kijkt of je 3 dezelfe kan
  ...
  for (i = 0; i <= 2; i++) {
    //kijkt of 4 opvolgende cijfers kan
    if (
      count[i] == 1 &&
      count[i + 1] == 1 &&
      count[i + 2] == 1 &&
  ...
  for (i = 0; i <= 1; i++) {
    //kijkt of 5 opvolgende cijfers kan
    if (
      count[i] == 1 &&
      count[i + 1] == 1 &&
      count[i + 2] == 1 &&
...
function reset() {
  // spreekt voorzich
  document.getElementsByClassName("rol")[0].innerHTML = "ROLLEN";
  for (let i = 0; i <= 4; i++) {
    document.getElementsByClassName("dobbelsteen")[i].style.backgroundImage =
      "url('dice6.png')";
    chosen[i] = false;
  }
  tel = 0;
...
document.addEventListener("click", function () {
  ...
  if (
    ...
    document.getElementsByClassName("rol")[0].innerHTML =
      "AF. Klik om weer te spelen";
    document.querySelector(".endScore").innerHTML =
      "Je hebt " + (totaalDeel2 + totaalDeel1) + " punten gehaald";
    document.getElementById("totaal-5").innerHTML = totaalDeel1 + totaalDeel2;
  }
});

document.querySelectorAll(".playAgain")[0].onclick,
